...
from pmpnn_ddg.features.compute_bundle import (  # noqa: E402
    build_v3_entry_from_extraction,
)
from pmpnn_ddg.extraction import (  # noqa: E402
...
from pmpnn_ddg.tensor_field_checks import write_tsv  # noqa: E402
...
TABLES = WORKSPACE_ROOT / "data" / "mutations"
...
DEFAULT_PDB_FALLBACK_DIR = (
    WORKSPACE_ROOT / "data" / "independent_pdbs" / "curated"
)
...
RF_KEEP_FIELDS = [
    ...
    "feature_A",
    "feature_B_historical_weighted", "feature_B_entropy_change_sum_weighted",
    "feature_B_manuscript_unweighted", "feature_B_entropy_change_sum_unweighted",
    "feature_C",
    "feature_D",
    "feature_F",
    "feature_G",
...
def main() -> int:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=WORKSPACE_ROOT / "results" / "extraction",
    )
