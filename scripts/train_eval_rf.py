...
from pmpnn_ddg.features import rf_feature_matrix_packing as packing


WORKSPACE = Path(__file__).resolve().parents[1]
DEFAULT_TENSOR_DIR = WORKSPACE / "data" / "tensors"
DEFAULT_OUTPUT = WORKSPACE / "results" / "table1"
...
def main() -> int:
    ...
    parser.add_argument("--digging-dir", type=Path, default=None, help="Deprecated alias for --tensor-dir")
    parser.add_argument(
        "--v3-pickle-override",
        action="append",
        default=[],
    ...
    digging = args.tensor_dir if args.digging_dir is None else args.digging_dir
    ...
    pickles = {
        "S_2648": digging / "S2648_extraction_tensors.pickle",
        "S_921": digging / "S921_extraction_tensors.pickle",
        "S_669": digging / "S669_extraction_tensors.pickle",
        "Ssym": digging / "Ssym_extraction_tensors.pickle",
    }
