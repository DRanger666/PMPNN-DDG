...
- `WORKSTREAM_SEPARATION.md`: separates historical recovery/reproduction,
  durable method science, focused V3 direct-tensor reconciliation,
  ThermoMPNN method enquiries, and later manuscript synthesis.
- `CODEX_SESSION_AND_GIT_WORKTREE_SEPARATION.md`: defines the multi-session and
  multi-Git-worktree/branch operating plan, with terminology rules.
